...
def write_data_to_csv(data):
    ...
    with open("properties-%s.csv" % (zipcode), 'wb') as csvfile:
        fieldnames = ["zpid", 'title', 'address', 'city', 'state', 'postal_code', 'price', 'facts and features', 'real estate provider', 'url']
...
def get_data_from_json(raw_json_data):
    ...
    try:
        ...
        with open("search_results.txt", 'w') as fp:
            fp.write(str(search_results))
...
def parse(zipcode, filter=None):
    ...
    for properties in search_results:
        raw_id = properties.xpath(".//span[@itemprop='address']//span[@itemprop='id']//text()")
